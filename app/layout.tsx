...
export default function RootLayout({
  ...
  return (
    <html lang="fr" className={geist.className}>
      <head>
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-FM63JGNETP" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-FM63JGNETP');` }} />
