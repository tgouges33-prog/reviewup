  ...
  return (
    <html lang="fr" className={geist.className}>
      <body className="bg-white text-gray-900 antialiased">
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-FM63JGNETP" strategy="afterInteractive" />
        <Script id="ga-init" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-FM63JGNETP');` }} />
