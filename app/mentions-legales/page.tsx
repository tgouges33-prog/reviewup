      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <strong>Email :</strong> [À COMPLÉTER — contact@votredomaine.fr]<br />
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <Link href="/confidentialite" className="text-[#667eea] hover:underline">Politique de confidentialité</Link>.
          </p>
        </section>
      </div>
    </div>
